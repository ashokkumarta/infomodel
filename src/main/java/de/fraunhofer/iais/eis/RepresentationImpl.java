...
@JsonTypeName("ids:Representation")
public class RepresentationImpl implements Serializable, Representation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Syntactic template of a Resource.", "en"));
	...
	*/
	...
	RepresentationImpl() {
		id = VocabUtil.getInstance().createRandomUrl("representation");
	}
