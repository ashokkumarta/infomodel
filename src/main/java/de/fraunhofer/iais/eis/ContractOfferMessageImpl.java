...
/** 
	...
	"Message containing a offered content contract (as offered by a data provider to the data consumer) in the associated payload (which is an instance of ContractOffer). In contrast to the ids:ContractResponseMessage, the ids:ContractOfferMessage is not related to a previous contract "@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ContractOfferMessage")
public class ContractOfferMessageImpl implements Serializable, ContractOfferMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract Offer Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a offered content contract (as offered by a data provider to the data consumer) in the associated payload (which is an instance of ContractOffer). In contrast to the ids:ContractResponseMessage, the ids:ContractOfferMessage is not related to a previous contract ", "en"));
	...
	*/
	...
	ContractOfferMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("contractOfferMessage");
	}
