...
/** 
	...
	"Resource (at least partially) comprising textual content."@en */
...
public class TextResourceImpl implements Serializable, TextResource {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Text Resource", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Resource (at least partially) comprising textual content.", "en"));
	...
	*/
	...
	TextResourceImpl() {
		id = VocabUtil.getInstance().createRandomUrl("textResource");
	}
