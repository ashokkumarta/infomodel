...
public class ImageRepresentationImpl implements Serializable, ImageRepresentation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Image Representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Image representation", "en"));
	...
	*/
	@JsonAlias({"ids:width", "width"})
	 java.math.BigDecimal _width;

	// no manual construction
	ImageRepresentationImpl() {
