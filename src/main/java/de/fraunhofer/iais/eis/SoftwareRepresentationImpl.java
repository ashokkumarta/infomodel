...
/** 
	"Software Representation"@en

	"Software representation"@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:SoftwareRepresentation")
public class SoftwareRepresentationImpl implements Serializable, SoftwareRepresentation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Software Representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Software representation", "en"));
	...
	*/
	...
	SoftwareRepresentationImpl() {
		id = VocabUtil.getInstance().createRandomUrl("softwareRepresentation");
	}
