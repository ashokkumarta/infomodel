...
@JsonTypeName("ids:AudioRepresentation")
public class AudioRepresentationImpl implements Serializable, AudioRepresentation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Audio Representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Audio representation", "en"));
	...
	*/
	@JsonAlias({"ids:samplingRate", "samplingRate"})
	 java.math.BigDecimal _samplingRate;
	...
	*/
	...
	AudioRepresentationImpl() {
		id = VocabUtil.getInstance().createRandomUrl("audioRepresentation");
	}
	...
	final public void setSamplingRate (java.math.BigDecimal _samplingRate_) {
		this._samplingRate = _samplingRate_;
	}
