...
@JsonTypeName("ids:DataRepresentation")
public class DataRepresentationImpl implements Serializable, DataRepresentation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Data representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Physical representation of (structured) data.", "en"));
	...
	*/
	@JsonAlias({"ids:dataTypeSchema", "dataTypeSchema"})
	 Resource _dataTypeSchema;
	...
	*/
	...
	DataRepresentationImpl() {
		id = VocabUtil.getInstance().createRandomUrl("dataRepresentation");
	}
	...
	final public void setDataType (URI _dataType_) {
	...
	final public void setDataTypeSchema (Resource _dataTypeSchema_) {
		this._dataTypeSchema = _dataTypeSchema_;
	}
