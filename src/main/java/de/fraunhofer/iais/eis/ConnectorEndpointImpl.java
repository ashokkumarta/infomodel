...
public class ConnectorEndpointImpl implements Serializable, ConnectorEndpoint {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Connector Endpoint", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Connector-specific endpoint exposing Artifacts.", "en"));
