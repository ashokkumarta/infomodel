...
public class VideoRepresentationImpl implements Serializable, VideoRepresentation {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Video Representation", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Video representation", "en"));
	...
	*/
	@JsonAlias({"ids:frameRate", "frameRate"})
	 java.math.BigDecimal _frameRate;
	...
	*/
	...
	final public void setFrameRate (java.math.BigDecimal _frameRate_) {
