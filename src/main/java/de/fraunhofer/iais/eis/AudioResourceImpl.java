...
/** 
	...
	"Resource (at least partially) comprising audio content."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:AudioResource")
public class AudioResourceImpl implements Serializable, AudioResource {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Audio Resource", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Resource (at least partially) comprising audio content.", "en"));
	...
	*/
	...
	AudioResourceImpl() {
		id = VocabUtil.getInstance().createRandomUrl("audioResource");
	}
