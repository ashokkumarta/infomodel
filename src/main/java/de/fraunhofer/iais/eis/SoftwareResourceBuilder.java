...
public class SoftwareResourceBuilder {
	...
	final public SoftwareResourceBuilder _assetRefinement_(AbstractConstraint _assetRefinement_) {
		this.softwareResourceImpl._assetRefinement = _assetRefinement_;
		return this;
	}
