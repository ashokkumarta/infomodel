...
@JsonTypeName("ids:Endpoint")
public class EndpointImpl implements Serializable, Endpoint {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Endpoint", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Access point of data exchange, service interaction and service description.", "en"));
	...
	*/
	...
	EndpointImpl() {
		id = VocabUtil.getInstance().createRandomUrl("endpoint");
	}
