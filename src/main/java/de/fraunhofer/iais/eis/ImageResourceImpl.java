...
/** 
	...
	"Resource (at least partially) comprising image content."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ImageResource")
public class ImageResourceImpl implements Serializable, ImageResource {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Image Resource", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Resource (at least partially) comprising image content.", "en"));
	...
	*/
	...
	"Conditions which specify whether an arbitrary ids:Asset is a member of this AssetCollection."@en
	...
	*/
	...
	ImageResourceImpl() {
		id = VocabUtil.getInstance().createRandomUrl("imageResource");
	}
