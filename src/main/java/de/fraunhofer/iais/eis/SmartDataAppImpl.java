...
public class SmartDataAppImpl implements Serializable, SmartDataApp {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Smart DataApp", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Smart DataApps are executing any kind of necessary data processing or transformation.", "en"));
