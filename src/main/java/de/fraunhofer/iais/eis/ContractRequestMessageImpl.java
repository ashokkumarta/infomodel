...
/** 
	"Contract Request Message"@en

	"Message containing a suggested content contract (as offered by the data consumer to the data provider) in the associated payload (which is an instance of ContractRequest)."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:ContractRequestMessage")
public class ContractRequestMessageImpl implements Serializable, ContractRequestMessage {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Contract Request Message", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Message containing a suggested content contract (as offered by the data consumer to the data provider) in the associated payload (which is an instance of ContractRequest).", "en"));
	...
	*/
	...
	ContractRequestMessageImpl() {
		id = VocabUtil.getInstance().createRandomUrl("contractRequestMessage");
	}
