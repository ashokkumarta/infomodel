...
/** 
	...
	"Resource (at least partially) comprising video content."@en */
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonTypeName("ids:VideoResource")
public class VideoResourceImpl implements Serializable, VideoResource {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Video Resource", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("Resource (at least partially) comprising video content.", "en"));
	...
	*/
	...
	VideoResourceImpl() {
		id = VocabUtil.getInstance().createRandomUrl("videoResource");
	}
