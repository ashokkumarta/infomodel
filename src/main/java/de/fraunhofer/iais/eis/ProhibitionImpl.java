...
public class ProhibitionImpl implements Serializable, Prohibition {
	...
	@JsonIgnore
	java.util.List<TypedLiteral> label = Arrays.asList(new TypedLiteral("Prohibition", "en"));
	//List of all comments of this class
	@JsonIgnore
	java.util.List<TypedLiteral> comment = Arrays.asList(new TypedLiteral("The class of Prohibitions as defined in the ODRL ontology.", "en"));
	...
	*/
	@JsonAlias({"ids:constraint", "constraint"})
	 java.util.ArrayList<? extends Constraint> _constraint;
	...
	*/
	...
	final public void setConstraint (java.util.ArrayList<? extends Constraint> _constraint_) {
